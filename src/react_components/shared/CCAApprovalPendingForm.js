...
import CCARequestlabel from './CCARequestlabel'

	class CCAApprovalPendingForm extends Component {
		constructor(props) {
			super(props);
			this.state = {
				cca_request_record_table: props.cca_request_record_table,
				cca_request_record_table_data: props.cca_request_record_table_data,
				flightDetail:props.flightDetail ,
				cca_request: props.cca_request,
				legops_record: props.legops_record
			}
		}
			...
			return (
				...
				<Observer>{() =>
							...
							<div className="col-12">
								<CCARequestlabel ccaRequestDetailsRecords={this.props.cca_request_record_table}/>
								{/* <label className="control-label">Existing CCA Records for Approval{this.props.cca_request_record_table}</label> */}
	...
	export default CCAApprovalPendingForm;